...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-row-padding">
      <div class="w3-container w3-white">
        ...
        <?php
            $id = $_GET['Id'];
            $sql = "SELECT * FROM brand WHERE br_id=$id";
            $result = mysqli_query($connect, $sql);
            while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
        ?>
        <form action="db_updateBrand.php" method="get">
            <input type="text" name="Id" value="<?php echo $row['br_id'] ?>" hidden>
            <input class="w3-input w3-border" type="text" name="Brand" value="<?php echo $row['br_name'] ?>" required>
            <br>
